...
export const isGcpPrincipalValid = (gcpPrincipal: string | undefined) => {
  // Accepts either email or domain format
  return isGcpEmailValid(gcpPrincipal) || isGcpDomainValid(gcpPrincipal);
};
