    ...
    >
      ...
      >
        <FormGroup label={<small>Public cloud</small>}>
          <div className="tiles">
            <RenderComponent when={supportedEnvironments?.includes('aws')}>
              <Tile
            ...
            <RenderComponent when={supportedEnvironments?.includes('gcp')}>
              <Tile
                className="tile pf-v6-u-mr-sm"
            ...
            <RenderComponent when={supportedEnvironments?.includes('azure')}>
              <Tile
                className="tile pf-v6-u-mr-sm"
      ...
      <RenderComponent when={supportedEnvironments?.includes('vsphere')}>
        <FormGroup
        ...
        >
          <Checkbox
            ...
            body={
              <>
                <RenderComponent
                  when={supportedEnvironments?.includes('vsphere-ova')}
                >
                  <Radio
                    name="vsphere-radio"
                          ...
                          bodyContent={
                            <Content>
                              <Content>
                                ...
                                virtualization platforms such as VMware vSphere.
                                It is a package that contains files used to
                                describe a virtual machine, which includes a
                                VMDK image, OVF descriptor file and a manifest
                                file.
                              </Content>
                            </Content>
                          }
                        ...
                        bodyContent={
                          <Content>
                            <Content>
                              ...
                              contents of a virtual machine. This disk has to be
                              imported into vSphere using govc import.vmdk, use
                              the OVA version when using the vSphere UI.
                            </Content>
                          </Content>
                        }
                      >
      ...
      <FormGroup label={<small>Other</small>}>
        <RenderComponent when={supportedEnvironments?.includes('guest-image')}>
          <Checkbox
        ...
        <RenderComponent
          when={supportedEnvironments?.includes('image-installer')}
        >
          <Checkbox
        ...
        <RenderComponent when={supportedEnvironments?.includes('wsl')}>
          <Checkbox
            label={
              <>
