...
describe('TargetEnvironment', () => {
  ...
  describe('Target selection', () => {
    test('clicking AWS card adds aws to image types', async () => {
    ...
    test('clicking AWS card twice removes aws from image types', async () => {
      const user = createUser();
      const { store } = renderTargetEnvironment();
    ...
    test('clicking guest image checkbox adds guest-image to image types', async () => {
      const user = createUser();
      const { store } = renderTargetEnvironment();
