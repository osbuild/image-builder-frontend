...
describe('Packages Component', () => {
  describe('Search Functionality', () => {
    ...
    test('shows default empty state', async () => {
      renderPackagesStep();
      expect(
        await screen.findByText(/search above to add additional/i),
      ).toBeInTheDocument();
    });
  ...
  describe('Pagination', () => {
    ...
    test('shows zero item count after clearing search input', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/search above to add additional/i),
        ).toBeInTheDocument();
      });
  ...
  describe('Selected Packages View', () => {
    ...
    test('shows empty state when no packages selected', async () => {
      ...
      expect(
        await screen.findByText(/no packages selected/i),
      ).toBeInTheDocument();
    });
  });
});
