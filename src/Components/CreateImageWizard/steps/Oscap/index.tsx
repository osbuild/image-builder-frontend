...
import OscapProfileDetails from './components/OscapProfileDetails';
  ...
  return (
    <>
      <Form>
        ...
        <Content>
          Select which Lightspeed Compliance policy or OpenSCAP profile you want
          your image to be compliant-ready for. Lightspeed Compliance allows the
          use of tailored policies, whereas OpenSCAP provides default versions.
          This step automatically helps monitor the adherence of your registered
          RHEL systems to a selected policy or profile.
        </Content>
        <FormGroup>
          <Switch
        ...
        {complianceEnabled && (
          <FormGroup>
              ...
              <Flex spaceItems={{ default: 'spaceItemsMd' }}>
                ...
                <FlexItem alignSelf={{ default: 'alignSelfFlexEnd' }}>
                  <Popover
                    ...
                    bodyContent={<OscapProfileDetails />}
                    minWidth='30'
                  >
                    <Button
                      variant='secondary'
            ...
            <Content width='32rem' className='pf-v6-u-pl-lg'>
              <ProfileSelector isDisabled={complianceType !== 'openscap'} />
              <FormHelperText>
                <HelperText>
                  <HelperTextItem>
                    {/* TODO: Add the correct URL */}
                    <ManageButton url={''} analyticsStepId='step-oscap'>
